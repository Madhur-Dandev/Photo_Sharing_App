...
const Profile = () => {
    ...
    const handleRemoveImage = async () => {
        ...
        if (data.success) {
            setUserInfo({ ...userInfo, user_picture: "" });
        }
    };
    ...
    return (
        <>
                            ...
                            <div className="flex flex-col md:flex-row gap-3 md:gap-10 items-center">
                                ...
                                <div className="flex gap-3">
                                    {!isOwn ? (
                                        ...
                                        <p
                                            className="text-base flex items-center font-extrabold bg-slate-200 text-stone-900 p-2 rounded-2xl cursor-pointer w-max mt-2 sm:mt-0 m-auto md:m-0"
                                            onClick={() =>
            ...
            {openImageOpt && (
                <div className="fixed top-0 left-0 w-screen h-screen flex justify-center items-center bg-black bg-opacity-40 animate-fadeIn z-30">
                    <div className="bg-slate-900 text-slate-200 flex flex-col text-center rounded-xl overflow-hidden">
                        <p
                            ...
                            onClick={() =>
                                document.querySelector("#new-picture").click()
                            }
                        >
                            New Photo
                            <input
