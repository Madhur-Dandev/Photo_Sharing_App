...
const ImgGrid = ({ showUserInfo }) => {
  /**
   * This component shows columns in grid of 3/2/1 for larger/medium/smaller size of screen respectively.
   * This component can be used to display search images, recommended images, and user's uploaded images in grid fashion.
   */

  // Array of all image element. This is temporary.
  const TEMPIMGSINFO = [
    {
      id: 1,
  ...
  const divider = (num) => {
    /**
     * This function will divide the result into specific numbers of column (num)
     */
    let returnArr = [];
    if (num > 0) {
